...
module.exports = {
  ...
  rules: {
    // using dangling for private properties
    ...
    // }],
    'react/forbid-prop-types': 'off', // it is hard to declare types when using jsx not tsx
    ...
    'react/jsx-curly-spacing': [ 'error', 'always' ], // styleguide
    ...
    // }],
    // Sometimes it is useful not to declare props
    ...
    'react/jsx-filename-extension': [ 'warn', { extensions: [ '.jsx', '.tsx', '.js' ] } ],
    ...
    //   skipShapeProps: true,
    // }],
    'react/no-unused-prop-types': 'off', // 'error' forces deconstruction in arguments
    ...
    'react/no-children-prop': 'off', // using children prop when defining callback
    ...
    // }],
    'react/require-default-props': 'off', // using object deconstruction functionality to set default values
    ...
    //   exceptions: [],
    // }],
    'react/jsx-props-no-spreading': 'off', // not comfortable to use
